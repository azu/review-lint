...
!(function(e) {
    ...
    var n = (function() {
        ...
        return (
            (n.prototype.record = function(t, n) {
...
!(function(e) {
    var t = (function() {
        function t() {}
        return (
            (t.validateConfigurationOptions = function(t, r) {
                return (
                    "string" != typeof (r = r || {}).baseUrl && (r.baseUrl = ""),
                    ...
                    ("object" == typeof r.ignoreDuplicateModules && Array.isArray(r.ignoreDuplicateModules)) ||
                    ...
                    ("number" != typeof r.nodeCachedDataWriteDelay || r.nodeCachedDataWriteDelay < 0) &&
                        (r.nodeCachedDataWriteDelay = 7e3),
                    "function" != typeof r.onNodeCachedData &&
                        (r.onNodeCachedData = function(e, t) {
                            e &&
            ...
            (t.mergeConfigurationOptions = function(r, n, o) {
                ...
                return (
                    e.Utilities.forEachProperty(n, function(t, r) {
                        "ignoreDuplicateModules" === t && void 0 !== i.ignoreDuplicateModules
                            ? (i.ignoreDuplicateModules = i.ignoreDuplicateModules.concat(r))
    ...
    var r = (function() {
        ...
        return (
            ...
            (r.prototype._applyPaths = function(t) {
                for (var r, n = 0, o = this.sortedPathsRules.length; n < o; n++)
                    if (((r = this.sortedPathsRules[n]), e.Utilities.startsWith(t, r.from))) {
                        for (var i = [], s = 0, a = r.to.length; s < a; s++) i.push(r.to[s] + t.substr(r.from.length));
                        return i;
                    }
                return [t];
            }),
            ...
            (r.prototype._addUrlArgsIfNecessaryToUrls = function(e) {
                if (this.options.urlArgs) for (var t = 0, r = e.length; t < r; t++) e[t] = this._addUrlArgsToUrl(e[t]);
                return e;
            }),
                ...
                if (e.Utilities.endsWith(n, ".js") || e.Utilities.isAbsolutePath(n))
                    ...
                    for (var o = 0, i = (r = this._applyPaths(n)).length; o < i; o++)
                        (this.isBuild() && "empty:" === r[o]) ||
                            (e.Utilities.isAbsolutePath(r[o]) || (r[o] = this.options.baseUrl + r[o]),
            ...
            (r.prototype.requireToUrl = function(t) {
                ...
                return (
                    e.Utilities.isAbsolutePath(r) ||
                        ((r = this._applyPaths(r)[0]), e.Utilities.isAbsolutePath(r) || (r = this.options.baseUrl + r)),
    ...
    var t = (function() {
            ...
            return (
                (e.prototype.load = function(e, t, r, n) {
                    var o = this,
                        i = { callback: r, errorback: n };
                    this.callbackMap.hasOwnProperty(t)
                        ? this.callbackMap[t].push(i)
        ...
        o = (function() {
            ...
            return (
                ...
                (t.prototype._initNodeRequire = function(t, r) {
                    ...
                    if (o && !this._didPatchNodeRequire) {
                        ...
                        s.prototype._compile = function(t, a) {
                            ...
                            return i._processCachedData(r, c, l), v;
                        };
                    }
                }),
                (t.prototype.load = function(r, n, o, i) {
                    ...
                    this._init(d), this._initNodeRequire(d, r);
                    var u = r.getRecorder();
                    if (/^node\|/.test(n)) {
                        var c = n.split("|"),
                            h = null;
                        ...
                        (n = e.Utilities.fileUriToFilePath(this._env.isWindows, n)),
                            this._fs.readFile(n, { encoding: "utf8" }, function(e, d) {
                                if (e) i(e);
                                else {
                                    ...
                                    if (s._env.isElectronRenderer) {
                                        var f = h.match(/^([a-z])\:(.*)/i);
                                        h = f
                                            ? "file:///" + (f[1].toUpperCase() + ":" + f[2]).replace(/\\/g, "/")
                                            : "file://" + h;
                                    }
                                    var p,
                                    ...
                                    if (
                                        ...
                                        s._fs.readFile(v, function(e, t) {
                                            var i = { filename: h, produceCachedData: void 0 === t, cachedData: t },
                                                a = s._loadAndEvalScript(r, n, h, p, i, u);
                                            o(), s._processCachedData(r, a, v);
                                        });
                                    } else s._loadAndEvalScript(r, n, h, p, { filename: h }, u), o();
                                }
                            });
                }),
                    ...
                    r.cachedDataRejected
                              ...
                              return o._fs.unlink(n, function(t) {
                                  t &&
                                      e
                                          .getConfig()
                                          .getOptionsLiteral()
                                          .onNodeCachedData({ errorCode: "unlink", path: n, detail: t });
                              });
                        ...
                        : r.cachedDataProduced &&
                          (e
                              .getConfig()
                              .getOptionsLiteral()
                              .onNodeCachedData(void 0, { path: n, length: r.cachedData.length }),
                          t._runSoon(function() {
                              return o._fs.writeFile(n, r.cachedData, function(t) {
                                  t &&
                                      e
                                          .getConfig()
                                          .getOptionsLiteral()
                                          .onNodeCachedData({ errorCode: "writeFile", path: n, detail: t });
                              });
                          }, e.getConfig().getOptionsLiteral().nodeCachedDataWriteDelay));
                }),
            ...
            (t.prototype.resolveModule = function(r) {
                ...
                return (
                    e.Utilities.isAbsolutePath(n) ||
                        ((e.Utilities.startsWith(n, "./") || e.Utilities.startsWith(n, "../")) &&
    ...
    var r = (function() {
        ...
        return (
            ...
            (t.prototype.complete = function(r, n, o) {
                ...
                i && n.onError({ errorCode: "factory", moduleId: this.strId, detail: i }),
        ...
        return (
            ...
            (s._findRelevantLocationInStack = function(e, t) {
                for (
                    ...
                    if (s) {
                        ...
                        if (((a = a.substr(u)), (a = r(a)) === n)) {
                            var c = { line: parseInt(d, 10), col: parseInt(l, 10) };
                            return (
                                1 === c.line &&
            ...
            (s.prototype.enqueueDefineAnonymousModule = function(e, t) {
                ...
                this._config.isBuild() && (r = new Error("StackLocation").stack),
                    (this._currentAnnonymousDefineCall = { stack: r, dependencies: e, callback: t });
            }),
            ...
            (s.prototype._onLoadError = function(e, t) {
                for (
                    var r = this._createLoadError(e, t), n = [], o = 0, i = this._moduleIdProvider.getMaxModuleId();
                    o < i;
                    o++
                )
                    n[o] = !1;
                        ...
                        if (a !== o.MODULE)
                            if (a !== o.REQUIRE) {
                                ...
                                if (d && d.isComplete()) e.unresolvedDependenciesCount--;
                                    ...
                                    c || ((c = []), this._inversePluginDependencies2.set(a.pluginId, c)),
                                        c.push(a),
            ...
            (s.prototype._onModuleComplete = function(e) {
                ...
                if (!e.isComplete()) {
                    ...
                    if (f) {
                        ...
                        for (var s = 0, a = f.length; s < a; s++) this._loadPluginDependency(e.exports, f[s]);
                    }
                }
            }),
            s
...
!(function(e) {
    ...
    function r() {
        ...
        if (((n = new e.ModuleManager(r, s, o, i, e.Utilities.getHighPerformanceTimestamp())), r.isNode)) {
            ...
            (e.global.nodeRequire = d), (i.nodeRequire = d);
        }
        r.isNode && !r.isElectronRenderer
            ? ((module.exports = i),
              ...
              (require = i))
            : (void 0 !== e.global.require && "function" != typeof e.global.require && i.config(e.global.require),
