...
!(function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        ...
        "function" == typeof define && define.amd && define("vs/language/css/workerManager", ["require", "exports"], e);
})(function(e, n) {
    function t(e) {
        var n,
            t,
    ...
    (function(e) {
        ...
        !(function(e) {
            function n(e, n, t, r, i) {
                ...
                return (
                    A.defined(t) && (o.severity = t), A.defined(r) && (o.code = r), A.defined(i) && (o.source = i), o
                );
            }
            function t(e) {
                var n = e;
        ...
        !(function(e) {
            function n(e, n) {
                ...
                var i = { label: e };
                return (
                    A.defined(n) && (i.documentation = n), A.defined(t) ? (i.parameters = t) : (i.parameters = []), i
                );
            }
            e.create = n;
    ...
    (function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            ...
            "function" == typeof define &&
                define.amd &&
                define("vs/language/css/languageFeatures", ["require", "exports", "vscode-languageserver-types"], e);
    })(function(e, n) {
        function t(e) {
            switch (e) {
        ...
        function o(e) {
            return e ? new p(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1) : void 0;
        }
        function a(e) {
    ...
    (function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            ...
            "function" == typeof define &&
                define.amd &&
                define("vs/language/css/cssMode", ["require", "exports", "./workerManager", "./languageFeatures"], e);
    })(function(e, n) {
        function t(e) {
            var n = [],
            ...
            n.push(monaco.languages.registerCompletionItemProvider(a, new i.CompletionAdapter(o))),
                ...
                n.push(monaco.languages.registerDocumentHighlightProvider(a, new i.DocumentHighlightAdapter(o))),
