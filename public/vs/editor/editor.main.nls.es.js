...
define("vs/editor/editor.main.nls.es", {
    ...
    "vs/editor/common/model/textModelWithTokens": ["Error en el modo al convertir la entrada en tokens."],
    ...
    "vs/editor/contrib/clipboard/browser/clipboard": ["Cortar", "Copiar", "Pegar", "Copiar con resaltado de sintaxis"],
    ...
    "vs/editor/contrib/goToDeclaration/browser/goToDeclarationMouse": ["Haga clic para mostrar {0} definiciones."],
    ...
    "vs/editor/contrib/parameterHints/browser/parameterHints": ["Sugerencias para parámetros Trigger"],
    ...
    "vs/editor/contrib/referenceSearch/browser/referenceSearch": [" – {0} referencias", "Buscar todas las referencias"],
