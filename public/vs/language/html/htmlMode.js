...
!(function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        ...
        "function" == typeof define &&
            define.amd &&
            define("vs/language/html/workerManager", ["require", "exports"], e);
})(function(e, t) {
    function n(e) {
        var t,
            n,
    ...
    (function(e) {
        ...
        !(function(e) {
            ...
            function n(e) {
                var t = e;
                return K.defined(t) && K.number(t.line) && K.number(t.character);
            }
            (e.create = t), (e.is = n);
        ...
        !(function(e) {
            function t(e, t, r, i) {
                if (K.number(e) && K.number(t) && K.number(r) && K.number(i))
            ...
            function r(e) {
                var t = e;
                return K.defined(t) && n.is(t.start) && n.is(t.end);
            }
            (e.create = t), (e.is = r);
        })((r = t.Range || (t.Range = {})));
        var i;
        !(function(e) {
            ...
            function n(e) {
                var t = e;
                return K.defined(t) && r.is(t.range) && (K.string(t.uri) || K.undefined(t.uri));
            }
            (e.create = t), (e.is = n);
        ...
        !(function(e) {
            function t(e, t, n, r, i) {
                ...
                return (
                    K.defined(n) && (o.severity = n), K.defined(r) && (o.code = r), K.defined(i) && (o.source = i), o
                );
            }
            function n(e) {
                var t = e;
                return (
                    ...
                    r.is(t.range) &&
                    K.string(t.message) &&
                    (K.number(t.severity) || K.undefined(t.severity)) &&
                    (K.number(t.code) || K.string(t.code) || K.undefined(t.code)) &&
                    (K.string(t.source) || K.undefined(t.source))
                );
            }
            (e.create = t), (e.is = n);
        ...
        !(function(e) {
            function t(e, t) {
                ...
                return K.defined(n) && n.length > 0 && (i.arguments = n), i;
            }
            function n(e) {
                var t = e;
                return K.defined(t) && K.string(t.title) && K.string(t.title);
            }
            (e.create = t), (e.is = n);
        ...
        !(function(e) {
            ...
            function n(e) {
                var t = e;
                return K.defined(t) && g.is(t.textDocument) && Array.isArray(t.edits);
            }
            (e.create = t), (e.is = n);
        ...
        !(function(e) {
            ...
            (e.create = t), (e.is = n);
        })((l = t.TextDocumentIdentifier || (t.TextDocumentIdentifier = {})));
        var g;
        !(function(e) {
            function t(e, t) {
            ...
            function n(e) {
                var t = e;
                return K.defined(t) && K.string(t.uri) && K.number(t.version);
            }
            (e.create = t), (e.is = n);
        })((g = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {})));
        var m;
        !(function(e) {
            function t(e, t, n, r) {
            ...
            function n(e) {
                var t = e;
                return (
                    K.defined(t) && K.string(t.uri) && K.string(t.languageId) && K.number(t.version) && K.string(t.text)
                );
            }
            (e.create = t), (e.is = n);
        ...
        })((h = t.InsertTextFormat || (t.InsertTextFormat = {})));
        var v;
        !(function(e) {
            function t(e) {
                return { label: e };
        ...
        !(function(e) {
            ...
            e.create = t;
        })((_ = t.CompletionList || (t.CompletionList = {})));
        var y;
        !(function(e) {
            function t(e) {
        ...
        !(function(e) {
            function t(e, t) {
                ...
                var i = { label: e };
                return (
                    K.defined(t) && (i.documentation = t), K.defined(n) ? (i.parameters = n) : (i.parameters = []), i
                );
            }
            e.create = t;
        ...
        })((C = t.DocumentHighlightKind || (t.DocumentHighlightKind = {})));
        var I;
        !(function(e) {
            function t(e, t) {
                var n = { range: e };
            ...
            e.create = t;
        })((I = t.DocumentHighlight || (t.DocumentHighlight = {})));
        var k;
        !(function(e) {
            (e.File = 1),
                (e.Module = 2),
        ...
        !(function(e) {
            ...
            e.create = t;
        })((w = t.SymbolInformation || (t.SymbolInformation = {})));
        var D;
        !(function(e) {
            function t(e) {
            ...
            function n(e) {
                var t = e;
                return K.defined(t) && K.typedArray(t.diagnostics, a.is);
            }
            (e.create = t), (e.is = n);
        })((D = t.CodeActionContext || (t.CodeActionContext = {})));
        var E;
        !(function(e) {
            function t(e, t) {
                var n = { range: e };
            ...
            function n(e) {
                var t = e;
                return K.defined(t) && r.is(t.range) && (K.undefined(t.command) || u.is(t.command));
            }
            (e.create = t), (e.is = n);
        ...
        !(function(e) {
            ...
            function n(e) {
                var t = e;
                return K.defined(t) && K.number(t.tabSize) && K["boolean"](t.insertSpaces);
            }
            (e.create = t), (e.is = n);
        ...
        (t.DocumentLink = T),
            (function(e) {
                ...
                function n(e) {
                    var t = e;
                    return K.defined(t) && r.is(t.range) && (K.undefined(t.target) || K.string(t.target));
                }
                (e.create = t), (e.is = n);
            })((T = t.DocumentLink || (t.DocumentLink = {}))),
            (t.DocumentLink = T),
            (t.EOL = ["\n", "\r\n", "\r"]);
        var M;
        !(function(e) {
            ...
            (e.create = t), (e.is = n);
        })((M = t.TextDocument || (t.TextDocument = {})));
        var P;
        !(function(e) {
    ...
    (function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            ...
            "function" == typeof define &&
                define.amd &&
                define("vs/language/html/languageFeatures", ["require", "exports", "vscode-languageserver-types"], e);
    })(function(e, t) {
        function n(e) {
            switch (e) {
                case l.DiagnosticSeverity.Error:
                    return monaco.Severity.Error;
                case l.DiagnosticSeverity.Warning:
                    return monaco.Severity.Warning;
                case l.DiagnosticSeverity.Information:
                case l.DiagnosticSeverity.Hint:
                default:
        ...
        function o(e) {
            if (e) return { start: i(e.getStartPosition()), end: i(e.getEndPosition()) };
        }
        function a(e) {
            if (e) return new g(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1);
        }
        function u(e) {
            var t = monaco.languages.CompletionItemKind;
            switch (e) {
                case l.CompletionItemKind.Text:
                    return t.Text;
                case l.CompletionItemKind.Method:
                    return t.Method;
                case l.CompletionItemKind.Function:
                    return t.Function;
                case l.CompletionItemKind.Constructor:
                    return t.Constructor;
                case l.CompletionItemKind.Field:
                    return t.Field;
                case l.CompletionItemKind.Variable:
                    return t.Variable;
                case l.CompletionItemKind.Class:
                    return t.Class;
                case l.CompletionItemKind.Interface:
                    return t.Interface;
                case l.CompletionItemKind.Module:
                    return t.Module;
                case l.CompletionItemKind.Property:
                    return t.Property;
                case l.CompletionItemKind.Unit:
                    return t.Unit;
                case l.CompletionItemKind.Value:
                    return t.Value;
                case l.CompletionItemKind.Enum:
                    return t.Enum;
                case l.CompletionItemKind.Keyword:
                    return t.Keyword;
                case l.CompletionItemKind.Snippet:
                    return t.Snippet;
                case l.CompletionItemKind.Color:
                    return t.Color;
                case l.CompletionItemKind.File:
                    return t.File;
                case l.CompletionItemKind.Reference:
                    return t.Reference;
            }
            return t.Property;
        }
        ...
        function c(e) {
            ...
            switch (e) {
                case l.DocumentHighlightKind.Read:
                    return t.Read;
                case l.DocumentHighlightKind.Write:
                    return t.Write;
                case l.DocumentHighlightKind.Text:
                    return t.Text;
            }
            return t.Text;
        }
            ...
            m = (function() {
                function e(e, t) {
                                ...
                                (n._listener[e.uri.toString()] = e.onDidChangeContent(function() {
                                    clearTimeout(r),
                                        (r = setTimeout(function() {
                                            return n._doValidate(e.uri, t);
                                        }, 500));
                                })),
                                    n._doValidate(e.uri, t);
                            }
                        },
                        i = function(e) {
                    ...
                    this._disposables.push(monaco.editor.onDidCreateModel(r)),
                        ...
                        this._disposables.push({
                            dispose: function() {
                                for (var e in n._listener) n._listener[e].dispose();
                            }
                        }),
                        ...
                        this._worker(e)
                            .then(function(n) {
                                return n.doValidation(e.toString()).then(function(n) {
                                    ...
                                    monaco.editor.setModelMarkers(monaco.editor.getModel(e), t, i);
                                });
                            })
        ...
        var p = (function() {
            ...
            return (
                ...
                (e.prototype.provideCompletionItems = function(e, t, n) {
                    var r = (e.getWordUntilPosition(t), e.uri);
                    return f(
                        n,
                        this._worker(r)
                            .then(function(e) {
                                return e.doComplete(r.toString(), i(t));
                            })
                            .then(function(e) {
                                if (e) {
                                    var t = e.items.map(function(e) {
                                        ...
                                        return (
                                            e.textEdit &&
                                                ((t.range = a(e.textEdit.range)), (t.insertText = e.textEdit.newText)),
                                            e.insertTextFormat === l.InsertTextFormat.Snippet &&
            ...
            return (
                (e.prototype.provideDocumentHighlights = function(e, t, n) {
                    ...
                    return f(
                        ...
                        this._worker(r)
                            .then(function(e) {
                                return e.findDocumentHighlights(r.toString(), i(t));
                            })
                            .then(function(e) {
                                if (e)
                                    return e.map(function(e) {
                                        return { range: a(e.range), kind: c(e.kind) };
                                    });
                            })
                    );
                }),
                    ...
                    return f(
                        ...
                        this._worker(n)
                            ...
                            .then(function(e) {
                                if (e)
                                    return e.map(function(e) {
                                        return { range: a(e.range), url: e.target };
                                    });
                            })
                    );
                }),
                ...
                (e.prototype.provideDocumentFormattingEdits = function(e, t, n) {
                    ...
                    return f(
                        ...
                        this._worker(r).then(function(e) {
                            return e.format(r.toString(), null, d(t)).then(function(e) {
        ...
        t.DocumentFormattingEditProvider = _;
        var y = (function() {
            function e(e) {
                this._worker = e;
            }
                ...
                (e.prototype.provideDocumentRangeFormattingEdits = function(e, t, n, r) {
                    ...
                    return f(
                        ...
                        this._worker(i).then(function(e) {
                            return e.format(i.toString(), o(t), d(n)).then(function(e) {
                                if (e && 0 !== e.length) return e.map(s);
                            });
                        })
                    );
        ...
        t.DocumentRangeFormattingEditProvider = y;
    }),
    (function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            var t = e(require, exports);
            ...
            "function" == typeof define &&
                define.amd &&
                define("vs/language/html/htmlMode", ["require", "exports", "./workerManager", "./languageFeatures"], e);
    })(function(e, t) {
        function n(e) {
            var t = [],
                n = new r.WorkerManager(e);
            t.push(n);
            var o = function() {
                ...
                a = e.languageId;
            t.push(monaco.languages.registerCompletionItemProvider(a, new i.CompletionAdapter(o))),
                t.push(monaco.languages.registerDocumentHighlightProvider(a, new i.DocumentHighlightAdapter(o))),
                t.push(monaco.languages.registerLinkProvider(a, new i.DocumentLinkAdapter(o))),
                "html" === a &&
                    (t.push(
                        monaco.languages.registerDocumentFormattingEditProvider(
                            a,
                            new i.DocumentFormattingEditProvider(o)
                        )
                    ),
                    t.push(
                        monaco.languages.registerDocumentRangeFormattingEditProvider(
                            a,
                            new i.DocumentRangeFormattingEditProvider(o)
                        )
                    ),
                    t.push(new i.DiagnostcsAdapter(a, o)));
        }
        Object.defineProperty(t, "__esModule", { value: !0 });
