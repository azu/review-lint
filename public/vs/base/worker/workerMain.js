...
(function() {
            ...
            return (
                (t.validateConfigurationOptions = function(t, n) {
                    return (
                        ...
                        ("object" == typeof n.ignoreDuplicateModules && Array.isArray(n.ignoreDuplicateModules)) ||
    ...
    !(function(e) {
        function t() {
            ...
            ((s = function() {
                ...
                i.defineModule(e.Utilities.generateAnonymousModule(), arguments[0], arguments[1], arguments[2], null);
            }).config = t),
        ...
        function n() {
            ...
            if (((i = new e.ModuleManager(n, u, o, s, e.Utilities.getHighPerformanceTimestamp())), n.isNode)) {
            ...
            n.isNode && !n.isElectronRenderer
                ? ((module.exports = s),
                  ...
                  (require = s))
                : (void 0 !== e.global.require && "function" != typeof e.global.require && s.config(e.global.require),
                ...
                return (
                    (e.prototype.getChangeType = function() {
                        return 0 === this.originalLength
                            ...
                            : 0 === this.modifiedLength ? t.DifferenceType.Remove : t.DifferenceType.Change;
                    }),
            ...
            var s = (function() {
                ...
                a = (function() {
                    ...
                    return (
                        ...
                        (e.prototype.WALKTRACE = function(e, t, r, i, o, u, a, l, c, f, h, d, p, m, _, g, v, y) {
                            var b,
                                C = null,
                                E = null,
                                S = new s(),
        ...
        r(e[21], t([1, 0]), function(e, t) {
            ...
            !(function() {
                function e(e, t, n, r) {
                    void 0 === n && (n = t), void 0 === r && (r = n), i.define(e, t), o.define(e, n), s.define(e, r);
                }
                e(0, "unknown"),
                    e(1, "Backspace"),
                    e(2, "Tab"),
        ...
        r(e[6], t([1, 0, 4]), function(e, t, n) {
            ...
            var s = (function() {
                ...
                return (
                    ...
                    (e.file = function(t) {
                        var r = e._empty;
                        if ((n.isWindows && (t = t.replace(/\\/g, e._slash)), t[0] === e._slash && t[0] === t[1])) {
                    ...
                    (e._asFormatted = function(t, n) {
                        ...
                        if (
                            ...
                            h && (l = h[1] ? "/" + h[2].toLowerCase() + l.substr(3) : h[2].toLowerCase() + l.substr(2));
                            for (var d = 0; ; ) {
    ...
    r(e[17], t([1, 0, 6]), function(e, t, n) {
        ...
        r(e[20], t([1, 0, 17]), function(e, t, n) {
            ...
            function c(e, t, n) {
                ...
                for (var r = 0; r < n; r++) {
                    ...
                    if (i !== o)
                        ...
                        } else if (String.fromCharCode(i).toLowerCase() !== String.fromCharCode(o).toLowerCase())
                            return !1;
                }
                return !0;
            }
            ...
            (t.format = function(e) {
                ...
                (t.indexOfIgnoreCase = function(e, t, n) {
                    void 0 === n && (n = 0);
                    var i = e.indexOf(t, n);
                    return i < 0 && (n > 0 && (e = e.substr(n)), (t = r(t)), (i = e.search(new RegExp(t, "i")))), i;
                }),
                (t.createRegExp = function(e, t, n) {
                    ...
                    var i = "";
                    return (
                        n.global && (i += "g"), n.matchCase || (i += "i"), n.multiline && (i += "m"), new RegExp(e, i)
                    );
                }),
        ...
        (function() {
            ...
            t("WinJS/Core/_Global", [], function() {
                ...
                return "undefined" != typeof window
                    ? window
                    : "undefined" != typeof self ? self : "undefined" != typeof global ? global : {};
            }),
                                ...
                                (void 0 === c.value && "function" != typeof c.get && "function" != typeof c.set)
                                    ? l
                                      ? u
                                        ...
                                        : (e[a] = c)
                                      : ((r = r || {})[a] = { value: c, enumerable: l, configurable: !0, writable: !0 })
                ...
                t(
                    ...
                    function(e, t, n, r, i, o) {
                        ...
                        function d(e, t, n, r) {
                            y(e, { c: t, e: n, p: r, asyncOpID: o._traceAsyncOperationStarting("WinJS.Promise.done") });
                        }
                        function p(e, t, n, r) {
        ...
        r(e[13], t([1, 0, 9]), function(e, t, n) {
            ...
            !(function(e) {
                (e.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: n.default.None })),
            ...
            var c = (function() {
                    ...
                    return (
                        ...
                        (e.prototype.handleMessage = function(e) {
                            ...
                            t.vsWorker &&
                                ((-1 !== this._workerId && t.vsWorker !== this._workerId) || this._handleMessage(t));
                        }),
                        ...
                        (t.prototype.getCharSequence = function(e, t) {
                            for (var n = [], r = [], i = e; i <= t; i++)
                                for (
                                    ...
                                    n.push({ offset: u, lineNumber: o.lineNumber, column: o.column + (u - o.offset) }),
                                        r.push({
                                            offset: u + 1,
                        ...
                        (e.createFromDiffResult = function(t, n, r, o, u) {
                            ...
                            if (
                                ...
                                var p = n.getCharSequence(t.originalStart, t.originalStart + t.originalLength - 1),
                                    ...
                                    _ = i(p, m, o, !1);
                                u && (_ = s(_)), (d = []);
                                for (var g = 0, v = _.length; g < v; g++) d.push(f.createFromDiffChange(_[g], p, m));
                            }
                        ...
                        (e.prototype.computeDiff = function() {
                            ...
                            for (var o = [], s = 0, u = 0, n = -1, a = e.length; n < a; n++) {
                                for (
                                    ...
                                    if (p !== m) {
                                        for (
                                            var _ = c._getFirstNonBlankColumn(p, 1),
                                                g = c._getFirstNonBlankColumn(m, 1);
        ...
        r(e[27], t([1, 0]), function(e, t) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                ...
                (t.DEFAULT_WORD_REGEXP = (function(e) {
                    void 0 === e && (e = "");
                    for (var n = t.USUAL_WORD_SEPARATORS, r = "(-?\\d*\\.\\d\\w*)|([^", i = 0; i < n.length; i++)
                ...
                return (
                    ...
                    (e.prototype.numberReplace = function(e, t) {
                        ...
                        return isNaN(r) || isNaN(i) || r !== i
                            ? null
                            : 0 !== r || t ? ((r = Math.floor(r * n)), (r += t ? n : -n), String(r / n)) : null;
                    }),
            ...
            var i = (function() {
                ...
                return (
                    ...
                    (e.prototype._getAccumulatedValue = function(e) {
                        ...
                        return (
                            (this.prefixSumValidIndex[0] = Math.max(this.prefixSumValidIndex[0], e)), this.prefixSum[e]
                        );
                    }),
                    (e.prototype.getIndexOf = function(e) {
                        (e = Math.floor(e)), this.getTotalValue();
                        for (var t, n, i, o = 0, s = this.values.length - 1; o <= s; )
                            if (((t = (o + (s - o) / 2) | 0), (n = this.prefixSum[t]), (i = n - this.values[t]), e < i))
                                s = t - 1;
                            else {
                                if (!(e >= n)) break;
                                o = t + 1;
        ...
        r(e[33], t([1, 0, 6, 2, 5, 26, 12, 3, 24, 28, 29, 27, 30]), function(e, t, n, r, i, s, u, a, l, c, f, h, d) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 });
            var p = (function(e) {
                    function t() {
                    ...
                    return (
                        ...
                        (e.prototype.navigateValueSet = function(e, t, n, i, o) {
                            ...
                            var a = s.getValueInRange(t),
                                l = s.getWordAtPosition({ lineNumber: t.startLineNumber, column: t.startColumn }, u),
                                c = null;
