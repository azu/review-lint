...
define("vs/editor/editor.main.nls.pt-br", {
    ...
    "vs/editor/browser/widget/diffEditorWidget": ["Não é possível comparar os arquivos pois um deles é muito grande."],
    ...
    "vs/editor/contrib/clipboard/browser/clipboard": ["Recortar", "Copiar", "Colar", "Copiar com realce de sintaxe"],
    ...
    "vs/editor/contrib/goToDeclaration/browser/goToDeclarationMouse": ["Clique para mostrar {0} definições."],
    ...
    "vs/editor/contrib/toggleTabFocusMode/common/toggleTabFocusMode": ["Alterne o uso da tecla Tab para mover o foco"],
