...
!(function(e) {
    ...
    !(function(e) {
        function t(e, t, r, i) {
            if (P.number(e) && P.number(t) && P.number(r) && P.number(i))
        ...
        function r(e) {
            var t = e;
            return P.defined(t) && n.is(t.start) && n.is(t.end);
        }
        (e.create = t), (e.is = r);
    })((r = t.Range || (t.Range = {})));
    var i;
    !(function(e) {
        ...
        function n(e) {
            var t = e;
            return P.defined(t) && r.is(t.range) && (P.string(t.uri) || P.undefined(t.uri));
        }
        (e.create = t), (e.is = n);
    ...
    !(function(e) {
        function t(e, t, n, r, i) {
            ...
            return P.defined(n) && (o.severity = n), P.defined(r) && (o.code = r), P.defined(i) && (o.source = i), o;
        }
        function n(e) {
            var t = e;
            return (
    ...
    !(function(e) {
        function t(e, t) {
            ...
            return P.defined(n) && n.length > 0 && (i.arguments = n), i;
        }
        function n(e) {
            var t = e;
        ...
        f = (function() {
            ...
            return (
                ...
                (e.prototype.getTextEditChange = function(e) {
                    ...
                    if (!n) {
                        var r = [];
                        (this._workspaceEdit.changes[e] = r), (n = new l(r)), (this._textEditChanges[e] = n);
                    }
                    return n;
                }),
                e
    ...
    !(function(e) {
        ...
        function n(e) {
            var t = e;
            return P.defined(t) && P.string(t.uri) && P.string(t.languageId) && P.number(t.version) && P.string(t.text);
        }
        (e.create = t), (e.is = n);
    ...
    !(function(e) {
        function t(e, t) {
            for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
            var i = { label: e };
            return P.defined(t) && (i.documentation = t), P.defined(n) ? (i.parameters = n) : (i.parameters = []), i;
        }
        e.create = t;
    ...
    !(function(e) {
        ...
        e.create = t;
    })((C = t.DocumentHighlight || (t.DocumentHighlight = {})));
    var k;
    !(function(e) {
        (e.File = 1),
            (e.Module = 2),
    ...
    !(function(e) {
        ...
        function n(e) {
            var t = e;
            return P.defined(t) && P.typedArray(t.diagnostics, a.is);
        }
        (e.create = t), (e.is = n);
    ...
    !(function(e) {
        ...
        function n(e) {
            var t = e;
            return P.defined(t) && r.is(t.range) && (P.undefined(t.command) || s.is(t.command));
        }
        (e.create = t), (e.is = n);
    ...
    (t.DocumentLink = w),
        (function(e) {
            ...
            function n(e) {
                var t = e;
                return P.defined(t) && r.is(t.range) && (P.undefined(t.target) || P.string(t.target));
            }
            (e.create = t), (e.is = n);
        })((w = t.DocumentLink || (t.DocumentLink = {}))),
        (t.DocumentLink = w),
        (t.EOL = ["\n", "\r\n", "\r"]);
    var A;
    !(function(e) {
    ...
    })((_ = t.TextDocumentSaveReason || (t.TextDocumentSaveReason = {})));
    var P,
        V = (function() {
            function e(e, t, n, r) {
                (this._uri = e),
    ...
    (function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            ...
            "function" == typeof define &&
                define.amd &&
                define("jsonc-parser/main", ["require", "exports", "vscode-nls"], e);
    })(function(e, t) {
        function n(e, t) {
            function n(t, n) {
            ...
            function a(e) {
                (d = e), (h = ""), (g = 0), (v = y.Unknown), (x = m.None);
            }
            function s() {
                var t = d;
                if (48 === e.charCodeAt(d)) d++;
                else for (d++; d < e.length && o(e.charCodeAt(d)); ) d++;
                if (d < e.length && 46 === e.charCodeAt(d)) {
                    if ((d++, !(d < e.length && o(e.charCodeAt(d)))))
                        return (x = m.UnexpectedEndOfNumber), e.substring(t, d);
                    for (d++; d < e.length && o(e.charCodeAt(d)); ) d++;
                }
                var n = d;
                if (d < e.length && (69 === e.charCodeAt(d) || 101 === e.charCodeAt(d)))
                    if (
                        (d++,
                        ((d < e.length && 43 === e.charCodeAt(d)) || 45 === e.charCodeAt(d)) && d++,
                        d < e.length && o(e.charCodeAt(d)))
                    ) {
                        for (d++; d < e.length && o(e.charCodeAt(d)); ) d++;
                        n = d;
            ...
            function c() {
                for (var t = "", r = d; ; ) {
                    if (d >= p) {
                        (t += e.substring(r, d)), (x = m.UnexpectedEndOfString);
                        break;
                    }
                    var o = e.charCodeAt(d);
                    if (34 === o) {
                    ...
                    if (92 !== o) {
                        if (o >= 0 && o <= 31) {
                            ...
                            x = m.InvalidCharacter;
                        }
                        d++;
                    } else {
                        if (((t += e.substring(r, d)), d++, d >= p)) {
            ...
            function u() {
                if (((h = ""), (x = m.None), (g = d), d >= p)) return (g = p), (v = y.EOF);
                var t = e.charCodeAt(d);
                if (r(t)) {
                    do d++, (h += String.fromCharCode(t)), (t = e.charCodeAt(d));
                    while (r(t));
                    return (v = y.Trivia);
                }
                if (i(t))
                    return (
                        ...
                        13 === t && 10 === e.charCodeAt(d) && (d++, (h += "\n")),
                        (v = y.LineBreakTrivia)
                    );
                switch (t) {
                    case 123:
                        return d++, (v = y.OpenBraceToken);
                    case 125:
                        return d++, (v = y.CloseBraceToken);
                    case 91:
                        return d++, (v = y.OpenBracketToken);
                    case 93:
                        return d++, (v = y.CloseBracketToken);
                    case 58:
                        return d++, (v = y.ColonToken);
                    case 44:
                        return d++, (v = y.CommaToken);
                    case 34:
                        return d++, (h = c()), (v = y.StringLiteral);
                    case 47:
                        var n = d - 1;
                        if (47 === e.charCodeAt(d + 1)) {
                            for (d += 2; d < p && !i(e.charCodeAt(d)); ) d++;
                            return (h = e.substring(n, d)), (v = y.LineCommentTrivia);
                        }
                        if (42 === e.charCodeAt(d + 1)) {
                            d += 2;
                            for (var a = p - 1, u = !1; d < a; ) {
                                var f = e.charCodeAt(d);
                                if (42 === f && 47 === e.charCodeAt(d + 1)) {
                                    (d += 2), (u = !0);
                                    break;
                                }
                                d++;
                            ...
                            return (
                                u || (d++, (x = m.UnexpectedEndOfComment)),
                                (h = e.substring(n, d)),
                                (v = y.BlockCommentTrivia)
                            );
                        }
                        return (h += String.fromCharCode(t)), d++, (v = y.Unknown);
                    case 45:
                        if (((h += String.fromCharCode(t)), d++, d === p || !o(e.charCodeAt(d))))
                            return (v = y.Unknown);
                    case 48:
                    case 49:
                    case 50:
                    ...
                    default:
                        for (; d < p && l(t); ) d++, (t = e.charCodeAt(d));
                        if (g !== d) {
                            switch ((h = e.substring(g, d))) {
                                case "true":
                ...
                switch (((i = o.getPosition()), (r = o.scan()))) {
                    ...
                    case y.EOF:
                        s !== i && a.push(e.substring(s, i)),
                            void 0 !== t && a.push(o.getTokenValue().replace(/[^\r\n]/g, t)),
                            (s = o.getPosition());
                }
            while (r !== y.EOF);
            return a.join("");
        ...
        function u(e, t) {
            ...
            var r = [],
                i = new Object(),
                o = void 0,
                a = { value: void 0, offset: void 0, length: void 0, type: void 0 },
                s = !1;
            try {
                h(e, {
                    ...
                    onSeparator: function(e, n, a) {
                        if (t <= n) throw i;
                        if (":" === e && "property" === o.type) (o.columnOffset = n), (s = !1), (o = void 0);
                        else if ("," === e) {
                            var c = r[r.length - 1];
                            "number" == typeof c ? (r[r.length - 1] = c + 1) : ((s = !0), (r[r.length - 1] = "")),
                                (o = void 0);
                        }
                    }
                });
            ...
            var o = { type: "array", offset: -1, length: -1, children: [] },
                a = {
                    ...
                    onObjectProperty: function(e, t, n) {
                        (o = i({ type: "property", offset: t, length: -1, parent: o, children: [] })),
        ...
        function p(e) {
            if ("array" === e.type) return e.children.map(p);
            if ("object" === e.type) {
                for (var t = {}, n = 0, r = e.children; n < r.length; n++) {
                    var i = r[n];
                    t[i.children[0].value] = p(i.children[1]);
                }
                return t;
            }
            return e.value;
        ...
        function h(e, t, r) {
            ...
            function s(e, t, n) {
                if ((void 0 === t && (t = []), void 0 === n && (n = []), k(e), t.length + n.length > 0))
            ...
            function u() {
                switch (h.getToken()) {
                    case y.NumericLiteral:
                        var e = 0;
                        try {
                            (e = JSON.parse(h.getTokenValue())),
                                "number" != typeof e && (s(x.InvalidNumberFormat), (e = 0));
                        } catch (t) {
            ...
            function l() {
                return h.getToken() !== y.StringLiteral
                    ? (s(x.PropertyNameExpected, [], [y.CloseBraceToken, y.CommaToken]), !1)
                    : (c(!1),
                      h.getToken() === y.ColonToken
                          ? (C(":"), a(), p() || s(x.ValueExpected, [], [y.CloseBraceToken, y.CommaToken]))
                          : s(x.ColonExpected, [], [y.CloseBraceToken, y.CommaToken]),
                      !0);
            }
            function f() {
                m(), a();
                for (var e = !1; h.getToken() !== y.CloseBraceToken && h.getToken() !== y.EOF; ) {
                    if (h.getToken() === y.CommaToken) {
                        if ((e || s(x.ValueExpected, [], []), C(","), a(), h.getToken() === y.CloseBraceToken && E))
                            break;
                    } else e && s(x.CommaExpected, [], []);
                    l() || s(x.ValueExpected, [], [y.CloseBraceToken, y.CommaToken]), (e = !0);
                }
                return (
                    v(), h.getToken() !== y.CloseBraceToken ? s(x.CloseBraceExpected, [y.CloseBraceToken], []) : a(), !0
                );
            }
            function d() {
                b(), a();
                for (var e = !1; h.getToken() !== y.CloseBracketToken && h.getToken() !== y.EOF; )
                    h.getToken() === y.CommaToken
                        ? (e || s(x.ValueExpected, [], []), C(","), a())
                        : e && s(x.CommaExpected, [], []),
                        p() || s(x.ValueExpected, [], [y.CloseBracketToken, y.CommaToken]),
                        (e = !0);
                return (
                    S(),
                    h.getToken() !== y.CloseBracketToken ? s(x.CloseBracketExpected, [y.CloseBracketToken], []) : a(),
                    !0
                );
            }
            function p() {
            ...
            return (
                ...
                h.getToken() === y.EOF ||
                    (p()
                        ? (h.getToken() !== y.EOF && s(x.EndOfFileExpected, [], []), !0)
                        : (s(x.ValueExpected, [], []), !1))
            );
        }
        var m,
        ...
        })((x = t.ParseErrorCode || (t.ParseErrorCode = {}))),
            (t.getParseErrorMessage = s),
            (t.getLocation = u),
            (t.parse = l),
            (t.parseTree = f),
            (t.findNodeAtLocation = d),
            (t.getNodeValue = p),
            (t.visit = h);
    }),
                ...
                return (
                    ...
                    (e.prototype.doComplete = function(e, t, n) {
                        ...
                        if (
                            ...
                            var l = a - c.length;
                            l > 0 && '"' === e.getText()[l - 1] && l--, (u = i.Range.create(e.positionAt(l), t));
                        } else u = i.Range.create(e.positionAt(s.start), e.positionAt(s.end));
                        var f = {},
                            d = {
                                add: function(e) {
                                    var t = f[e.label];
                                    t
                                        ...
                                        : ((f[e.label] = e),
                                          u && (e.textEdit = i.TextEdit.replace(u, e.insertText)),
                                          o.items.push(e));
                                },
                        ...
                        return this.schemaService.getSchemaForResource(e.uri, n).then(function(t) {
                            ...
                            if (s && "string" === s.type) {
                                var g = s;
                                g.isKey &&
                                    ((p = !(s.parent && s.parent.value)),
                                    (m = s.parent ? s.parent : null),
                                    (h = e.getText().substring(s.start + 1, s.end - 1)),
                                    s.parent && (s = s.parent.parent));
                            }
                            if (s && "object" === s.type) {
                                if (s.start === a) return o;
                                var v = s.properties;
                                v.forEach(function(e) {
                                    (m && m === e) || (f[e.key.value] = i.CompletionItem.create("__"));
                                });
                                var y = "";
                                p && (y = r.evaluateSeparatorAfter(e, e.offsetAt(u.end))),
                                    t
                                        ? r.getPropertyCompletions(t, n, s, p, y, d)
                                        : r.getSchemaLessPropertyCompletions(n, s, h, d);
                                var x = s.getPath();
                                r.contributions.forEach(function(t) {
                                    var n = t.collectPropertyCompletions(e.uri, x, c, p, "" === y, d);
                                    n && l.push(n);
                                }),
                                    !t &&
                                        c.length > 0 &&
                                        '"' !== e.getText().charAt(a - c.length - 1) &&
                                        d.add({
                            ...
                            if (
                                (t
                                    ? r.getValueCompletions(t, n, s, a, S, d, T)
                                    : r.getSchemaLessValueCompletions(n, s, a, S, e, d),
                                s)
                            ) {
                                if ("property" === s.type && a > s.colonOffset) {
                                    ...
                                    if (!k || a <= k.end) {
                                        ...
                                        r.contributions.forEach(function(t) {
                                            var n = t.collectValueCompletions(e.uri, O, C, d);
                                            n && l.push(n);
                                        });
                                    }
                                }
                                ...
                                r.contributions.forEach(function(t) {
                                    var n = t.collectDefaultCompletions(e.uri, d);
                                    n && l.push(n);
                                });
                            return r.promise.all(l).then(function() {
                                return 0 === d.getNumberOfProposals() && r.addFillerValueCompletions(T, S, d), o;
                            });
                        });
                    }),
                                ...
                                if (n > u.colonOffset) {
                                    ...
                                    e.visit(function(e) {
                                        ...
                                        "$schema" === f &&
                                            t.parent &&
                                            !t.parent.parent &&
                                            this.addDollarSchemaCompletions(r, a);
                                }
                            }
                            if ("array" === t.type)
                                if (t.parent && "property" === t.parent.type) {
                                    var d = t.parent.key.value;
                                    e.visit(function(e) {
                                        var t = e;
                                        return (
                                            "property" === e.type &&
                    ...
                    (e.prototype.getValueCompletions = function(e, t, n, r, i, o, a) {
                        ...
                        if (n) {
                            ...
                            if (n && (null !== c || "array" === n.type)) {
                                var l = [];
                                t.validate(e.schema, l, n.start),
                                    l.forEach(function(e) {
                                        if (
                                            e.node === n &&
                                            !e.inverted &&
                                            e.schema &&
                                            (e.schema.items && s.addSchemaValueCompletions(e.schema.items, i, o, a),
                                            e.schema.properties)
                                        ) {
                                    ...
                                    "$schema" !== c || n.parent || this.addDollarSchemaCompletions(i, o),
                                    a["boolean"] &&
                                        (this.addBooleanValueCompletion(!0, i, o),
                                        this.addBooleanValueCompletion(!1, i, o)),
                                    a["null"] && this.addNullValueCompletion(i, o);
                            }
                    ...
                    (e.prototype.getLabelForSnippetValue = function(e) {
                        ...
                        return (
                            (t = t.replace(/\$\{\d+:([^}]+)\}|\$\d+/g, "$1")),
                            t.length > 57 ? t.substr(0, 57).trim() + "..." : t
                        );
                    }),
                    ...
                    (e.prototype.getInsertTextForProperty = function(e, t, n, r) {
                        ...
                        if (t) {
                            var a = t["default"];
                            if ("undefined" != typeof a) o += this.getInsertTextForGuessedValue(a, "");
                    ...
                    (e.prototype.isInComment = function(e, t, r) {
                        ...
                        for (var o = i.scan(); o !== n.SyntaxKind.EOF && i.getTokenOffset() + i.getTokenLength() < r; )
                            o = i.scan();
                        return (
                            (o === n.SyntaxKind.LineCommentTrivia || o === n.SyntaxKind.BlockCommentTrivia) &&
                            i.getTokenOffset() <= r
                        );
                    }),
                    e
    ...
    (function(e) {
        ...
        var r = e("vscode-languageserver-types"),
            i = (function() {
                ...
                return (
                    (e.prototype.doHover = function(e, t, i) {
                        var o = e.offsetAt(t),
                            a = i.getNodeFromOffset(o);
                        if (!a || (("object" === a.type || "array" === a.type) && o > a.start + 1 && o < a.end - 1))
                        ...
                        if ("string" === a.type) {
                            ...
                            if (c.isKey) {
                                var u = a.parent;
                                if (((a = u.value), !a)) return this.promise.resolve(void 0);
                            }
                        }
                        for (
                            var l = r.Range.create(e.positionAt(s.start), e.positionAt(s.end)),
                                f = function(e) {
                                    var t = { contents: e, range: l };
                                    return t;
                                },
                                d = a.getPath(),
                            ...
                            var h = this.contributions[p],
                                m = h.getInfoContribution(e.uri, d);
                            if (m)
                                return m.then(function(e) {
                                    return f(e);
                                });
                        }
                        return this.schemaService.getSchemaForResource(e.uri, i).then(function(e) {
                            if (e) {
                                var t = [];
                                i.validate(e.schema, t, a.start);
                                var r = null,
                                    o = null,
                                    s = null,
                                    c = null;
                                t.every(function(e) {
                                    if (
                                        ...
                                        e.schema &&
                                        ((r = r || e.schema.title),
                                        (o = o || e.schema.description),
                                        e.schema["enum"] && e.schema.enumDescriptions)
                                    ) {
                                        var t = e.schema["enum"].indexOf(a.getValue());
                ...
                return (
                    ...
                    (e.prototype.doValidation = function(e, t) {
                        return this.validationEnabled
                            ? this.jsonSchemaService.getSchemaForResource(e.uri, t).then(function(r) {
                                  if (r)
                                      if (r.errors.length && t.root) {
                                          ...
                                          if (o) {
                                              var a = o.value || o;
                                              t.warnings.push({
                                                  location: { start: a.start, end: a.end },
                                                  message: r.errors[0]
                                              });
                                          } else
                                              t.warnings.push({
                                                  location: { start: i.start, end: i.start + 1 },
                                                  message: r.errors[0]
                                              });
                                  ...
                                  var s = [],
                                      c = {};
                                  return (
                                      t.errors.concat(t.warnings).forEach(function(r, i) {
                                          ...
                                          if (!c[o]) {
                                              ...
                                              s.push({
                                                  severity:
                                                      i >= t.errors.length
                                                          ? n.DiagnosticSeverity.Warning
                                                          : n.DiagnosticSeverity.Error,
                                                  range: a,
                                                  message: r.message
                                              });
                                          }
    ...
    (function(e) {
        ...
        (t.startsWith = n), (t.endsWith = r), (t.convertSimple2RegExpPattern = i), (t.repeat = o);
    }),
    (function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            var t = e(require, exports);
            ...
            "function" == typeof define &&
                ...
                define(
                    ...
                    ["require", "exports", "../utils/strings", "vscode-languageserver-types"],
                    e
                );
    })(function(e, t) {
                ...
                return (
                    (e.prototype.findDocumentSymbols = function(e, t) {
                        ...
                        if (
                            ("vscode://defaultsettings/keybindings.json" === a ||
                                n.endsWith(a.toLowerCase(), "/user/keybindings.json")) &&
                            "array" === o.type
                        ) {
                            var s = [];
                            return (
                                o.items.forEach(function(t) {
                                    if ("object" === t.type) {
                                        ...
                                        if (n && n.value) {
                                            var i = r.Location.create(
                                                e.uri,
                                                r.Range.create(e.positionAt(t.start), e.positionAt(t.end))
                                            );
                                            s.push({
                        ...
                        var c = function(t, n, o) {
                                if ("array" === n.type)
                                    ...
                                    a.properties.forEach(function(n) {
                                        var a = r.Location.create(
                                                e.uri,
                                                r.Range.create(e.positionAt(n.start), e.positionAt(n.end))
                                            ),
                                            s = n.value;
                                        if (s) {
                    ...
                    (e.prototype.findColorSymbols = function(e, t) {
                        return this.schemaService.getSchemaForResource(e.uri, t).then(function(n) {
                            ...
                            if (n) {
                                var o = [];
                                t.validate(n.schema, o);
                                for (var a = {}, s = 0, c = o; s < c.length; s++) {
                                    var u = c[s];
                                    if (
                                        !u.inverted &&
                                        u.schema &&
                                        ...
                                        var l = String(u.node.start);
                                        a[l] ||
                                            (i.push(
                                                r.Range.create(e.positionAt(u.node.start), e.positionAt(u.node.end))
                                            ),
                                            (a[l] = !0));
                                    }
                                }
    ...
    (function(e) {
        ...
        function n(e, t) {
            ...
            if (Array.isArray(e)) {
                ...
                var a = [];
                for (i in t) a.push(i);
                if ((a.sort(), !n(o, a))) return !1;
                for (r = 0; r < o.length; r++) if (!n(e[o[r]], t[o[r]])) return !1;
            }
            return !0;
        }
        t.equals = n;
...
!(function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        ...
        "function" == typeof define &&
            ...
            define(
                ...
                ["require", "exports", "jsonc-parser", "../utils/objects", "vscode-nls"],
                e
            );
})(function(e, t) {
    function n(e, t) {
            ...
            for (;;) {
                ...
                switch (e) {
                    ...
                    case i.SyntaxKind.BlockCommentTrivia:
                        j && a(s("InvalidCommentTokem", "Comments are not allowed"), r.CommentsNotAllowed);
                        break;
        ...
        function a(t, r, o, a, s) {
            if (
                ...
                void 0 === a && (a = []),
                void 0 === s && (s = []),
                0 === O.errors.length || O.errors[0].location.start !== E.getTokenOffset())
            ) {
                var c = E.getTokenOffset(),
                    u = E.getTokenOffset() + E.getTokenLength();
                if (c === u && c > 0) {
                    for (c--; c > 0 && /\s/.test(e.charAt(c)); ) c--;
                    u = c + 1;
                }
                O.errors.push({ message: t, location: { start: c, end: u }, code: r });
            }
            if ((o && g(o, !1), a.length + s.length > 0))
                for (var l = E.getToken(); l !== i.SyntaxKind.EOF; ) {
                    if (a.indexOf(l) !== -1) {
                        n();
                        break;
                    }
                    if (s.indexOf(l) !== -1) break;
                    l = n();
                }
            return o;
        }
        function c() {
            switch (E.getTokenError()) {
                case i.ScanError.InvalidUnicode:
                    return a(s("InvalidUnicode", "Invalid unicode sequence in string"), r.InvalidUnicode), !0;
                case i.ScanError.InvalidEscapeCharacter:
                    return (
                        a(s("InvalidEscapeCharacter", "Invalid escape character in string"), r.InvalidEscapeCharacter),
                        !0
                    );
                case i.ScanError.UnexpectedEndOfNumber:
                    return a(s("UnexpectedEndOfNumber", "Unexpected end of number"), r.UnexpectedEndOfNumber), !0;
                case i.ScanError.UnexpectedEndOfComment:
                    return a(s("UnexpectedEndOfComment", "Unexpected end of comment"), r.UnexpectedEndOfComment), !0;
                case i.ScanError.UnexpectedEndOfString:
                    return a(s("UnexpectedEndOfString", "Unexpected end of string"), r.UnexpectedEndOfString), !0;
                case i.ScanError.InvalidCharacter:
                    return (
                        a(
                            s("InvalidCharacter", "Invalid characters in string. Control characters must be escaped."),
                            r.InvalidCharacter
                        ),
                        !0
                    );
        ...
        function g(e, t) {
            return (e.end = E.getTokenOffset() + E.getTokenLength()), t && n(), e;
        }
        function y(e, t) {
            if (E.getToken() !== i.SyntaxKind.OpenBracketToken) return null;
            var c = new f(e, t, E.getTokenOffset());
            n();
            var u = 0;
            if (c.addItem(k(c, u++)))
                for (; o(i.SyntaxKind.CommaToken); )
                    c.addItem(k(c, u++)) || I || a(s("ValueExpected", "Value expected"), r.Undefined);
            return E.getToken() !== i.SyntaxKind.CloseBracketToken
                ? a(s("ExpectedCloseBracket", "Expected comma or closing bracket"), r.Undefined, c)
                : g(c, !0);
        }
        function x(e, t) {
            var o = S(null, null, !0);
            if (!o) {
                if (E.getToken() === i.SyntaxKind.Unknown) {
                    var c = E.getTokenValue();
                    c.match(/^['\w]/) &&
                        a(s("DoubleQuotesExpected", "Property keys must be doublequoted"), r.Undefined);
                }
                return null;
            }
            var u = new h(e, o);
            return (
                t[o.value] &&
                    O.warnings.push({
                        location: { start: u.key.start, end: u.key.end },
                        message: s("DuplicateKeyWarning", "Duplicate object key"),
                        code: r.Undefined
                    }),
                (t[o.value] = !0),
                E.getToken() !== i.SyntaxKind.ColonToken
                    ? a(
                          s("ColonExpected", "Colon expected"),
                          r.Undefined,
                          u,
                          [],
                          [i.SyntaxKind.CloseBraceToken, i.SyntaxKind.CommaToken]
                      )
                    : ((u.colonOffset = E.getTokenOffset()),
                      n(),
                      u.setValue(k(u, o.value))
                          ? ((u.end = u.value.end), u)
                          : a(
                                s("ValueExpected", "Value expected"),
                                r.Undefined,
                                u,
                                [],
                                [i.SyntaxKind.CloseBraceToken, i.SyntaxKind.CommaToken]
        ...
        function b(e, t) {
            if (E.getToken() !== i.SyntaxKind.OpenBraceToken) return null;
            var c = new m(e, t, E.getTokenOffset());
            n();
            var u = Object.create(null);
            if (c.addProperty(x(c, u)))
                for (; o(i.SyntaxKind.CommaToken); )
                    c.addProperty(x(c, u)) || I || a(s("PropertyExpected", "Property expected"), r.Undefined);
            return E.getToken() !== i.SyntaxKind.CloseBraceToken
                ? a(s("ExpectedCloseBrace", "Expected comma or closing brace"), r.Undefined, c)
                : g(c, !0);
        }
        function S(e, t, n) {
            if (E.getToken() !== i.SyntaxKind.StringLiteral) return null;
            var r = new p(e, t, n, E.getTokenOffset());
            return (r.value = E.getTokenValue()), c(), g(r, !0);
        }
        function T(e, t) {
            if (E.getToken() !== i.SyntaxKind.NumericLiteral) return null;
            var n = new d(e, t, E.getTokenOffset());
            if (!c()) {
                var o = E.getTokenValue();
                try {
                    var u = JSON.parse(o);
                    if ("number" != typeof u)
                        return a(s("InvalidNumberFormat", "Invalid number format"), r.Undefined, n);
                    n.value = u;
                } catch (l) {
                    return a(s("InvalidNumberFormat", "Invalid number format"), r.Undefined, n);
                }
                n.isInteger = o.indexOf(".") === -1;
            }
            return g(n, !0);
        }
        function C(e, t) {
            ...
            switch (E.getToken()) {
                ...
                case i.SyntaxKind.TrueKeyword:
                    n = new l(e, t, !0, E.getTokenOffset());
                    break;
                case i.SyntaxKind.FalseKeyword:
                    n = new l(e, t, !1, E.getTokenOffset());
                    break;
                default:
                    return null;
            }
        ...
        function k(e, t) {
            return y(e, t) || b(e, t) || S(e, t, !1) || T(e, t) || C(e, t);
        }
        var O = new v(t),
            E = i.createScanner(e, !1),
            j = t && t.disallowComments,
            I = t && t.ignoreDanglingComma;
        return (
            n(),
            (O.root = k(null, null)),
            O.root
                ? E.getToken() !== i.SyntaxKind.EOF && a(s("End of file expected", "End of file expected"), r.Undefined)
                : a(s("Invalid symbol", "Expected a JSON object, array or literal"), r.Undefined),
            O
        );
    }
    var r,
                        ...
                        (Array.isArray(e.type)
                            ...
                            : e.type &&
                              ...
                              t.warnings.push({
                                  ...
                                  message:
                                      e.errorMessage ||
                                      s("typeMismatchWarning", 'Incorrect type. Expected "{0}"', e.type)
                              }),
                        Array.isArray(e.allOf) &&
                            e.allOf.forEach(function(e) {
                                a.validate(e, t, n, i);
                    ...
                    var l = function(e, r) {
                        ...
                        return (
                            e.forEach(function(e) {
                                var t = new g(),
                                    n = [];
                                if ((a.validate(e, t, n), t.hasErrors() || i.push(e), o))
                                    if (r || t.hasErrors() || o.validationResult.hasErrors()) {
                                        var s = t.compare(o.validationResult);
                                        s > 0
                                            ? (o = { schema: e, validationResult: t, matchingSchemas: n })
                                            : 0 === s &&
                                              (o.matchingSchemas.push.apply(o.matchingSchemas, n),
                                              o.validationResult.mergeEnumValueMismatch(t));
                                    } else
                                        o.matchingSchemas.push.apply(o.matchingSchemas, n),
                                            (o.validationResult.propertiesMatches += t.propertiesMatches),
                                            (o.validationResult.propertiesValueMatches += t.propertiesValueMatches);
                                else o = { schema: e, validationResult: t, matchingSchemas: n };
                            }),
                            i.length > 1 &&
                                r &&
                                t.warnings.push({
                                    location: { start: a.start, end: a.start + 1 },
                                    message: s("oneOfWarning", "Matches multiple schemas when only one must validate.")
                                }),
                            null !== o &&
                                (t.merge(o.validationResult),
                                (t.propertiesMatches += o.validationResult.propertiesMatches),
                                (t.propertiesValueMatches += o.validationResult.propertiesValueMatches),
                                n && n.push.apply(n, o.matchingSchemas)),
                            i.length
                        );
                    };
                    if (
                        (Array.isArray(e.anyOf) && l(e.anyOf, !1),
                        Array.isArray(e.oneOf) && l(e.oneOf, !0),
                        Array.isArray(e["enum"]))
                    ) {
                        for (var f = this.getValue(), d = !1, p = 0, h = e["enum"]; p < h.length; p++) {
                            var m = h[p];
                            if (o.equals(f, m)) {
                                d = !0;
                                break;
                            ...
                            : (t.warnings.push({
                                  ...
                                  message:
                                      ...
                                      s(
                                          ...
                                          JSON.stringify(e["enum"])
                                      )
                              }),
                              (t.mismatchedEnumValues = e["enum"]));
                    }
    ...
    var f = (function(e) {
        ...
        return (
            __extends(t, e),
            (t.prototype.getChildNodes = function() {
                return this.items;
            }),
                    ...
                    if ((e.prototype.validate.call(this, t, n, r, i), Array.isArray(t.items))) {
                        ...
                        a.forEach(function(e, t) {
                            var s = new g(),
                                c = o.items[t];
                            c
                                ? (c.validate(e, s, r, i), n.mergePropertyMatch(s))
                                : o.items.length >= a.length && n.propertiesValueMatches++;
                        }),
                            t.additionalItems === !1 && this.items.length > a.length
                                ? n.warnings.push({
                                      location: { start: this.start, end: this.end },
                                      message: s(
                                ...
                                : this.items.length >= a.length &&
                                  (n.propertiesValueMatches += this.items.length - a.length);
                    } else
                        t.items &&
    ...
    var d = (function(e) {
        ...
        return (
            ...
            (t.prototype.validate = function(t, n, r, i) {
                if ((void 0 === i && (i = -1), i === -1 || this.contains(i))) {
                    var o = !1;
                    ("integer" === t.type || (Array.isArray(t.type) && t.type.indexOf("integer") !== -1)) && (o = !0),
                        o && this.isInteger === !0 && (this.type = "integer"),
                    ...
                    "number" == typeof t.multipleOf &&
                        ...
                        n.warnings.push({
                            location: { start: this.start, end: this.end },
                            message: s("multipleOfWarning", "Value is not divisible by {0}", t.multipleOf)
                        }),
                        "number" == typeof t.minimum &&
                            (t.exclusiveMinimum &&
                                a <= t.minimum &&
                                n.warnings.push({
                                    location: { start: this.start, end: this.end },
                            ...
                            !t.exclusiveMinimum &&
                                ...
                                n.warnings.push({
                                    location: { start: this.start, end: this.end },
                                    message: s("minimumWarning", "Value is below the minimum of {0}", t.minimum)
                                })),
                        "number" == typeof t.maximum &&
                            (t.exclusiveMaximum &&
                                a >= t.maximum &&
                                n.warnings.push({
                                    location: { start: this.start, end: this.end },
                            ...
                            !t.exclusiveMaximum &&
                                ...
                                n.warnings.push({
                                    location: { start: this.start, end: this.end },
                                    message: s("maximumWarning", "Value is above the maximum of {0}", t.maximum)
                                }));
                }
            }),
            t
                    ...
                    o.test(this.value) ||
                        n.warnings.push({
                            ...
                            message:
                                ...
                                t.errorMessage ||
                                s("patternWarning", 'String does not match the pattern of "{0}"', t.pattern)
                        });
                }
            }),
            t
    ...
    var h = (function(e) {
        ...
        return (
            ...
            (t.prototype.validate = function(e, t, n, r) {
                void 0 === r && (r = -1),
                    (r === -1 || this.contains(r)) && this.value && this.value.validate(e, t, n, r);
            }),
            t
        );
    })(c);
            ...
            (t.prototype.getValue = function() {
                ...
                return (
                    this.properties.forEach(function(t) {
                        ...
                        "undefined" != typeof n && (e[t.key.getValue()] = n);
                    }),
                    e
                );
            }),
            ...
            (t.prototype.validate = function(t, n, r, i) {
                ...
                if ((void 0 === i && (i = -1), i === -1 || this.contains(i))) {
                    ...
                    this.properties.forEach(function(e) {
                        var t = e.key.value;
                        (a[t] = e.value), c.push(t);
                    }),
                        Array.isArray(t.required) &&
                            t.required.forEach(function(e) {
                                if (!a[e]) {
                                    var t = o.parent && o.parent && o.parent.key,
                                        r = t ? { start: t.start, end: t.end } : { start: o.start, end: o.start + 1 };
                                    n.warnings.push({
                                        location: r,
                    ...
                    t.properties &&
                        Object.keys(t.properties).forEach(function(e) {
                            ...
                            if (s) {
                                var c = new g();
                                s.validate(o, c, r, i), n.mergePropertyMatch(c);
                            }
                        }),
                        t.patternProperties &&
                            Object.keys(t.patternProperties).forEach(function(e) {
                                var o = new RegExp(e);
                                c.slice(0).forEach(function(s) {
                                    if (o.test(s)) {
                                        u(s);
                                        var c = a[s];
                                        if (c) {
                        ...
                        "object" == typeof t.additionalProperties
                            ? c.forEach(function(e) {
                                  ...
                                  if (o) {
                                      var s = new g();
                                      o.validate(t.additionalProperties, s, r, i), n.mergePropertyMatch(s);
                                  }
                              })
                              ...
                              c.forEach(function(e) {
                                  ...
                                  if (r) {
                                      ...
                                      n.warnings.push({
                                          ...
                                          message:
                                              t.errorMessage ||
                                              s("DisallowedExtraPropWarning", "Property {0} is not allowed", e)
                                      });
                                  }
                              }),
                        t.maxProperties &&
                            this.properties.length > t.maxProperties &&
                            n.warnings.push({
                                location: { start: this.start, end: this.end },
                                message: s(
                                    "MaxPropWarning",
                        ...
                        t.minProperties &&
                            this.properties.length < t.minProperties &&
                            n.warnings.push({
                                location: { start: this.start, end: this.end },
                                message: s(
                                    "MinPropWarning",
                        ...
                        t.dependencies &&
                            Object.keys(t.dependencies).forEach(function(e) {
                                var c = a[e];
                                if (c)
        ...
        return (
            ...
            (e.prototype.mergeEnumValueMismatch = function(e) {
                if (this.mismatchedEnumValues && e.mismatchedEnumValues) {
                    ...
                    for (var t = 0, n = this.warnings; t < n.length; t++) {
                        var i = n[t];
                        i.code === r.EnumValueMismatch &&
                            (i.message = s(
                                "enumWarning",
                                "Value is not accepted. Valid values: {0}",
                                JSON.stringify(this.mismatchedEnumValues)
                            ));
                    }
            ...
            (e.prototype.mergePropertyMatch = function(e) {
                this.merge(e),
                    ...
                    (e.enumValueMatch || (!e.hasErrors() && e.propertiesMatches)) && this.propertiesValueMatches++;
            }),
            (e.prototype.compare = function(e) {
                var t = this.hasErrors();
                return t !== e.hasErrors()
                    ? t ? -1 : 1
    ...
    t.ValidationResult = g;
    var v = (function() {
        function e(e) {
            this.validationResult = new g();
        }
        return (
            ...
            (e.prototype.validate = function(e, t, n) {
                void 0 === t && (t = null),
                    void 0 === n && (n = -1),
                    this.root && this.root.validate(e, this.validationResult, t, n);
            }),
            e
        );
    })();
    (t.JSONDocument = v), (t.parse = n);
}),
    (function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            var t = e(require, exports);
    ...
    (function(e) {
        ...
        var o = (function() {
            ...
            return (
                        ...
                        if (!this._fsPath) {
                            ...
                            (t =
                                this._authority && this._path && "file" === this.scheme
                                    ...
                                    : e._driveLetterPath.test(this._path)
                ...
                (e.file = function(t) {
                    ...
                    if (
                        ((n._scheme = "file"),
                        a && (t = t.replace(/\\/g, e._slash)),
                        t[0] === e._slash && t[0] === t[1])
                    ) {
                        var r = t.indexOf(e._slash, 2);
                        r === -1
                            ? (n._authority = t.substring(2))
                            : ((n._authority = t.substring(2, r)), (n._path = t.substring(r)));
                    } else n._path = t;
                ...
                (e._asFormatted = function(t, n) {
                    var o = n ? i : r,
                        ...
                        l = t.query,
                        f = t.fragment;
                    if ((s && a.push(s, ":"), (c || "file" === s) && a.push("//"), c)) {
                        c = c.toLowerCase();
                        var d = c.indexOf(":");
                        d === -1 ? a.push(o(c)) : a.push(o(c.substr(0, d)), c.substr(d));
                    }
                    if (u) {
                        var p = e._upperCaseDrive.exec(u);
                        p && (u = p[1] ? "/" + p[2].toLowerCase() + u.substr(3) : p[2].toLowerCase() + u.substr(2));
                        for (var h = 0; ; ) {
                            var d = u.indexOf(e._slash, h);
                            if (d === -1) {
                                a.push(o(u.substring(h)));
                                break;
                            }
                            a.push(o(u.substring(h, d)), e._slash), (h = d + 1);
                        }
                    }
                    return l && a.push("?", o(l)), f && a.push("#", o(f)), a.join(e._empty);
                }),
        ...
        (o._empty = ""),
            ...
            (t["default"] = o);
        var a;
        if ("object" == typeof process) a = "win32" === process.platform;
        ...
        if ("object" == typeof module && "object" == typeof module.exports) {
            ...
            "function" == typeof define &&
                ...
                define(
                    ...
                    ["require", "exports", "jsonc-parser", "vscode-uri", "../utils/strings", "vscode-nls"],
                    e
                );
    })(function(e, t) {
        function n(e) {
        ...
        var r = e("jsonc-parser"),
            ...
            u = (function() {
                function e(e, t, n) {
                    (this.service = e),
                        (this.url = t),
                        n && (this.unresolvedSchema = this.service.promise.resolve(new l(n)));
                }
                return (
                ...
                (e.prototype.resolveSchemaContent = function(e, t) {
                    var n = this,
                        ...
                        c = function(e, t, n) {
                            ...
                            else r.push(s("json.schema.invalidref", "$ref '{0}' in {1} can not be resolved.", n, t.id));
                            delete e.$ref;
                        },
                        u = function(e, t, i, a) {
                            return (
                                o && !/^\w+:\/\/.*/.test(t) && (t = o.resolveRelativePath(t, a)),
                                (t = n.normalizeId(t)),
                                n
                                    .getOrAddSchemaHandle(t)
                                    .getUnresolvedSchema()
                                    .then(function(n) {
                                        if (n.errors.length) {
                                            var o = i ? t + "#" + i : t;
                            ...
                            for (
                                ...
                                if (!(o.indexOf(d) >= 0)) {
                                    if ((o.push(d), d.$ref)) {
                                        var p = d.$ref.split("#", 2);
                                        if (p[0].length > 0) {
                                            a.push(u(d, p[0], p[1], r));
                                            continue;
                                        }
                                        c(d, t, p[1]);
                                    }
                                    s(d.items, d.additionalProperties, d.not),
                                        l(d.definitions, d.properties, d.patternProperties, d.dependencies),
                                        f(d.anyOf, d.allOf, d.oneOf, d.items);
                                }
                            }
    ...
    (function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            ...
            "function" == typeof define &&
                define.amd &&
                define(
                    "vscode-json-languageservice/services/jsonFormatter",
                    ["require", "exports", "jsonc-parser", "vscode-languageserver-types", "../utils/strings"],
                    e
                );
    })(function(e, t) {
        function n(e, t, n) {
            function u() {
                return T + c.repeat(S, d + k);
            }
            function l() {
                var e = O.scan();
                for (C = !1; e === a.SyntaxKind.Trivia || e === a.SyntaxKind.LineBreakTrivia; )
                    (C = C || e === a.SyntaxKind.LineBreakTrivia), (e = O.scan());
                return (E = e === a.SyntaxKind.Unknown || O.getTokenError() !== a.ScanError.None), e;
            }
            function f(t, n, r) {
                if (!E && n < g && r > m && v.substring(n, r) !== t) {
                    var i = s.Range.create(e.positionAt(n), e.positionAt(r));
                    j.push(s.TextEdit.replace(i, t));
                }
            }
            var d,
                p,
            ...
            if (t) {
                ...
                var y = s.Position.create(t.start.line, 0);
                h = e.offsetAt(y);
                for (
                    var x = e.offsetAt(s.Position.create(t.end.line + 1, 0)),
                        b = e.offsetAt(s.Position.create(t.end.line, 0));
                    x > b && o(v, x - 1);

                )
                    x--;
                (p = v.substring(h, x)), (d = r(p, 0, n));
            } else (p = v), (d = 0), (h = 0), (m = 0), (g = v.length);
            var S,
                T = i(e),
                C = !1,
                k = 0;
            S = n.insertSpaces ? c.repeat(" ", n.tabSize) : "\t";
            var O = a.createScanner(p, !1),
                E = !1,
                j = [],
                I = l();
            if (I !== a.SyntaxKind.EOF) {
                var w = O.getTokenOffset() + h,
                    A = c.repeat(S, d);
                f(A, h, w);
            }
            for (; I !== a.SyntaxKind.EOF; ) {
                for (
                    var _ = O.getTokenOffset() + O.getTokenLength() + h, P = l(), V = "";
                    !C && (P === a.SyntaxKind.LineCommentTrivia || P === a.SyntaxKind.BlockCommentTrivia);

                ) {
                    var F = O.getTokenOffset() + h;
                    f(" ", _, F),
                        (_ = O.getTokenOffset() + O.getTokenLength() + h),
                        (V = P === a.SyntaxKind.LineCommentTrivia ? u() : ""),
                        (P = l());
                }
                if (P === a.SyntaxKind.CloseBraceToken) I !== a.SyntaxKind.OpenBraceToken && (k--, (V = u()));
                else if (P === a.SyntaxKind.CloseBracketToken) I !== a.SyntaxKind.OpenBracketToken && (k--, (V = u()));
                else {
                    switch (I) {
                        case a.SyntaxKind.OpenBracketToken:
                        case a.SyntaxKind.OpenBraceToken:
                            k++, (V = u());
                            break;
                        case a.SyntaxKind.CommaToken:
                        case a.SyntaxKind.LineCommentTrivia:
                            V = u();
                            break;
                        case a.SyntaxKind.BlockCommentTrivia:
                            V = C ? u() : " ";
                            break;
                        case a.SyntaxKind.ColonToken:
                            V = " ";
                            break;
                        case a.SyntaxKind.StringLiteral:
                            if (P === a.SyntaxKind.ColonToken) {
                                V = "";
                                break;
                            }
                        case a.SyntaxKind.NullKeyword:
                        case a.SyntaxKind.TrueKeyword:
                        case a.SyntaxKind.FalseKeyword:
                        case a.SyntaxKind.NumericLiteral:
                        case a.SyntaxKind.CloseBraceToken:
                        case a.SyntaxKind.CloseBracketToken:
                            P === a.SyntaxKind.LineCommentTrivia || P === a.SyntaxKind.BlockCommentTrivia
                                ? (V = " ")
                                : P !== a.SyntaxKind.CommaToken && P !== a.SyntaxKind.EOF && (E = !0);
                    }
                    !C || (P !== a.SyntaxKind.LineCommentTrivia && P !== a.SyntaxKind.BlockCommentTrivia) || (V = u());
                }
                var K = O.getTokenOffset() + h;
                f(V, _, K), (I = P);
            }
            return j;
        }
        ...
        function i(e) {
            var t = e.getText();
            if (e.lineCount > 1) {
                for (var n = e.offsetAt(s.Position.create(1, 0)), r = n; r > 0 && o(t, r - 1); ) r--;
        ...
        var a = e("jsonc-parser"),
            ...
            c = e("../utils/strings");
        t.format = n;
        [a.SyntaxKind.LineCommentTrivia, a.SyntaxKind.BlockCommentTrivia, a.SyntaxKind.CommaToken];
    }),
    (function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            var t = e(require, exports);
        ...
        function n(e) {
            ...
            var r = new i.JSONCompletion(n, e.contributions, t),
                d = new o.JSONHover(n, e.contributions, t),
                p = new s.JSONDocumentSymbols(n),
            ...
            return {
                ...
                findDocumentSymbols: p.findDocumentSymbols.bind(p),
                findColorSymbols: p.findColorSymbols.bind(p),
        ...
        (t.TextDocument = r.TextDocument),
            ...
            (t.CompletionItem = r.CompletionItem),
            (t.CompletionList = r.CompletionList),
            (t.Range = r.Range),
            (t.SymbolInformation = r.SymbolInformation),
            (t.Diagnostic = r.Diagnostic),
            (t.TextEdit = r.TextEdit),
            (t.FormattingOptions = r.FormattingOptions),
            (t.MarkedString = r.MarkedString);
        ...
        if ("object" == typeof module && "object" == typeof module.exports) {
            ...
            "function" == typeof define &&
                ...
                define(
                    ...
                    ["require", "exports", "vscode-json-languageservice", "vscode-languageserver-types"],
                    e
                );
    })(function(e, t) {
        function n(e, t) {
