...
define("vs/editor/editor.main.nls.ja", {
    ...
    "vs/editor/browser/widget/diffEditorWidget": ["一方のファイルが大きすぎるため、ファイルを比較できません。"],
    ...
    "vs/editor/contrib/caretOperations/common/caretOperations": ["キャレットを左に移動", "キャレットを右に移動"],
    "vs/editor/contrib/caretOperations/common/transpose": ["文字の入れ替え"],
    "vs/editor/contrib/clipboard/browser/clipboard": ["切り取り", "コピー", "貼り付け", "構文を強調表示してコピー"],
    ...
    "vs/editor/contrib/goToDeclaration/browser/goToDeclarationMouse": ["クリックして、{0} の定義を表示します。"],
    ...
    "vs/editor/contrib/referenceSearch/browser/referenceSearch": ["– {0} 個の参照", "すべての参照の検索"],
    ...
    "vs/editor/contrib/toggleTabFocusMode/common/toggleTabFocusMode": ["Tab キーを切り替えるとフォーカスが移動します"],
