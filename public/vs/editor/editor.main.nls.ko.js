...
define("vs/editor/editor.main.nls.ko", {
    ...
    "vs/base/browser/ui/findinput/findInputCheckboxes": ["대/소문자 구분", "단어 단위로", "정규식 사용"],
    ...
    "vs/editor/common/model/textModelWithTokens": ["입력을 토큰화하는 동안 모드에서 오류가 발생했습니다."],
    ...
    "vs/editor/contrib/caretOperations/common/caretOperations": ["캐럿을 왼쪽으로 이동", "캐럿을 오른쪽으로 이동"],
    "vs/editor/contrib/caretOperations/common/transpose": ["문자 바꾸기"],
    "vs/editor/contrib/clipboard/browser/clipboard": ["잘라내기", "복사", "붙여넣기", "구문을 강조 표시하여 복사"],
    ...
    "vs/editor/contrib/goToDeclaration/browser/goToDeclarationMouse": ["{0}개 정의를 표시하려면 클릭하세요."],
    ...
    "vs/editor/contrib/inPlaceReplace/common/inPlaceReplace": ["이전 값으로 바꾸기", "다음 값으로 바꾸기"],
    ...
    "vs/editor/contrib/multicursor/common/multicursor": ["위에 커서 추가", "아래에 커서 추가", "줄 끝에 커서 추가"],
    ...
    "vs/editor/contrib/quickFix/browser/quickFixCommands": ["수정 사항 표시({0})", "수정 사항 표시", "빠른 수정"],
    ...
    "vs/editor/contrib/toggleTabFocusMode/common/toggleTabFocusMode": ["<Tab> 키로 포커스 이동 설정/해제"],
